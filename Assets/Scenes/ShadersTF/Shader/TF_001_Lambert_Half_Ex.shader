...
////// Emissive:
                ...
                float node_5321_if_leA = step(_hightlight_size_1_var,dot(lightDirection,normalize((i.normalDir+_light_offset_1_var.rgb))));
                float node_5321_if_leB = step(dot(lightDirection,normalize((i.normalDir+_light_offset_1_var.rgb))),_hightlight_size_1_var);
                float node_2078 = 1.0;
                float node_9622 = 0.0;
                ...
                float node_9545_if_leA = step(_hightlight_size_2_var,dot(lightDirection,normalize((i.normalDir+_light_offset_2_var.rgb))));
                float node_9545_if_leB = step(dot(lightDirection,normalize((i.normalDir+_light_offset_2_var.rgb))),_hightlight_size_2_var);
                float4 _Fresnel_color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Fresnel_color );
                float3 emissive = saturate((1.0-(1.0-lerp(_ColorRamp_var.rgb,_highlight_color_var.rgb,saturate(max(lerp((node_5321_if_leA*node_2078)+(node_5321_if_leB*node_9622),node_2078,node_5321_if_leA*node_5321_if_leB),lerp((node_9545_if_leA*node_2078)+(node_9545_if_leB*node_9622),node_2078,node_9545_if_leA*node_9545_if_leB)))))*(1.0-(pow(1.0-max(0,dot(normalDirection, viewDirection)),3.0)*_Fresnel_color_var.rgb))));
